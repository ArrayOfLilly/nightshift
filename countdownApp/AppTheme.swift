...
enum AppTheme {
    ...
    static let freeColors: [Color] = [
        // Color(red: 0x77/255, green: 0x80/255, blue: 0x05/255), // #778005 olive-yellow
        // Color(red: 0x51/255, green: 0x42/255, blue: 0x2E/255), // #51422E lighter brown
        // Color(red: 0x30/255, green: 0x27/255, blue: 0x1B/255), // #30271B dark brown
        // Color(red: 0x29/255, green: 0x3B/255, blue: 0x72/255), // #293B72 navy
        // Color(red: 0x4D/255, green: 0x70/255, blue: 0xD8/255), // #4D70D8 blue
        // Color(red: 0x40/255, green: 0x38/255, blue: 0x73/255), // #403873 dark purple
        // Color(red: 0x59/255, green: 0x3C/255, blue: 0x73/255), // #593C73 purple
        Color(red: 0x8A/255, green: 0x42/255, blue: 0x73/255), // #8A4273 magenta-purple
        // Color(red: 0x72/255, green: 0x3F/255, blue: 0x73/255), // #723F73 mid purple
        // Color(red: 0xDD/255, green: 0x3B/255, blue: 0x72/255), // #DD3B72 pink-red
        // Color(red: 0xDD/255, green: 0x11/255, blue: 0x4A/255), // #DD114A hot red-pink
        // Color(red: 0xB7/255, green: 0x0E/255, blue: 0x26/255), // #B70E26 deep red
    ]
